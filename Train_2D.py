...
if __name__ == '__main__':
    ...
    print("Training ...")
    my_generator = Generator2D()

    batch_size = config[TrainingParams.batch_size]
    data_augmentation = config[TrainingParams.data_augmentation]
    train_generator = my_generator.unet_2d_single_stream(input_folder=input_folder,
                                                         folders_to_read=folders_to_read[train_ids],
                                                         stream_file_names=img_names,
                                                         ctrs_file_names=ctr_names, # Single contour
                                                         data_augmentation=data_augmentation,
                                                         batch_size=batch_size)

    val_generator = my_generator.unet_2d_single_stream(input_folder=input_folder,
